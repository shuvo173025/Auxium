    ...
    ui(new Ui::message)
{
    ...
    if(r=="stdf"||r=="tecf")
    {
       ...
       QString  filename="D:/New folder/RS_project-master/Student/"+id+".txt";
       ...
       QString  filename="D:/New folder/RS_project-master/Teacher/"+id+".txt";
       QFile file2( filename );
       if ( file2.open(QIODevice::ReadOnly) )
       {
           QTextStream in(&file2);
...
void message::on_pushButton_2_clicked()
{
    ...
    QString filename="D:/New folder/RS_project-master/message.txt";
    QFile file2( filename );
    ...
    QString a=ui->plainTextEdit->toPlainText();
    QString b=ui->lineEdit->text();
    QString filename="D:/New folder/RS_project-master/Teacher/"+b+".txt";
    QFile file2( filename );
    if ( file2.open(QIODevice::WriteOnly | QIODevice::Text | QIODevice::Append ) )
    {
