...
if(user=="Student"){
    ...
    {
        hide();
    QString filename="D:/New folder/RS_project-master/student.txt";
    QFile file( filename );
    ...
    file.close();
    filename="D:/New folder/RS_project-master/Student/"+id+".txt";
...
if(user=="Teacher"){
    ...
    {
        hide();
    QString filename="D:/New folder/RS_project-master/teacher.txt";
    QFile file( filename );
    if ( file.open(QIODevice::ReadWrite | QIODevice::Text | QIODevice::Append) )
    {
        QTextStream stream( &file );
    ...
    file.close();
    filename="D:/New folder/RS_project-master/Teacher/"+id+".txt";
    QFile file2( filename );
    if ( file2.open(QIODevice::WriteOnly | QIODevice::Text ) )
    {
        QTextStream stream( &file2 );
