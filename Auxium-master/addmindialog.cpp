...
{
    ui->setupUi(this);
    filename="D:/New folder/RS_project-master/message.txt";
...
void addminDialog::on_pushButton_3_clicked()
{
    ...
    QString filename="D:/New folder/RS_project-master/Student/"+b+".txt";
    QFile file2( filename );
...
void addminDialog::on_pushButton_clicked()
{
    ...
    QDir dir;
    dir.remove(filename);
    QString filename2="D:/New folder/RS_project-master/Student.txt";
    ...
    file.close();
      ...
      QString filename44="D:/New folder/RS_project-master/Student.txt";
...
qDebug()<<"reag";
    ...
    file2.close();
     ...
     filename="D:/New folder/RS_project-master/Teacher/"+b+".txt";
    QDir dir2;
    dir2.remove(filename);
     filename2="D:/New folder/RS_project-master/Teacher.txt";
